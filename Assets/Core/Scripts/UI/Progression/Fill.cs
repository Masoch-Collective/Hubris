...
namespace UI.Progression {
    ...
    public class Fill : MonoBehaviour {
        ...
        public void Update() {
            ...
            float setToHeight = (effectiveIndex == Parent.levels + 1) ? Parent.filledHeight : effectiveIndex == 0 ? 0 : (Parent.max - Parent.min) * (effectiveIndex / (float)Parent.levels) + Parent.min;
